...
- On 3 August 2026, the owner reduced the desktop identity-logo scale while retaining the approved nearly full-viewport hero height and two-column composition. Mobile logo sizing remains unchanged.
- On 3 August 2026, the owner added the Indonesian motto `Mengabdi untuk Negeri` above the academic name lockup. It remains separate from the page heading and appears in Indonesian on both locale variants until an English rendering receives editorial approval.
- On 3 August 2026, the owner increased the `Prof.` prefix and degree-suffix scale in the homepage academic lockup so both sit closer in proportion to the display name while remaining visibly subordinate.
- On 3 August 2026, the owner approved a mobile-only public-design audit and refinement. At 840px and below, language, menu, and footer targets retain a minimum 44px touch area; at 720px and below, the Profile opening removes redundant vertical offset and publication/research notices replace decorative left stripes with quieter horizontal rules. Desktop composition and spacing remain unchanged.
